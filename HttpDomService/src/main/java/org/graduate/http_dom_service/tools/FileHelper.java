package org.graduate.http_dom_service.tools;
...
public final class FileHelper {
    ...
    public static void writeToFileResult(File file, boolean result) {
        ...
        logger.info(logger.getName() + file.getName() + " write to file failed");
    }
     ...
     */
    public static void createNotExistFile(File file) throws IOException {
        if (!file.exists()) {
            // 创建新文件
            logger.info(logger.getName() + " " + file.getName() + " is not exits, will create it.");
            if (file.createNewFile()) {
                logger.info(logger.getName() + " " + file.getName() + " file create success.");
            }
        }
    }
}
